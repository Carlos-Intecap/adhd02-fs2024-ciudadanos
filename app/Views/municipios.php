...
<body class="bg-info-subtle">
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-2">Municipios</h1>

        <a href="nuevo_municipio" class="btn btn-success"><i class="bi-plus-circle"></i> Nuevo municipio</a>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td>
                        <a href="<?=base_url('buscar_municipio/').$municipio['cod_muni']?>" class="btn btn-warning"><i
                                class="bi-pencil-square"></i></a>
                        <a href="<?=base_url('eliminar_municipio/').$municipio['cod_muni']?>" class="btn btn-danger"><i
                                class="bi-trash"></i></a>
                    </td>
                </tr>
                <?php
