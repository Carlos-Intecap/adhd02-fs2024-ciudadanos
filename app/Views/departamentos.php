...
<body class="bg-info-subtle">
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-2">Departamentos</h1>

        <a href="nuevo_departamento" class="btn btn-success"><i class="bi-plus-circle"></i> Nuevo departamento</a>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td>
                        <a href="<?=base_url('buscar_departamento/').$departamento['cod_depto']?>" class="btn btn-warning"><i
                                class="bi-pencil-square"></i></a>
                        <a href="<?=base_url('eliminar_departamento/').$departamento['cod_depto']?>" class="btn btn-danger"><i
                                class="bi-trash"></i></a>
                    </td>
                </tr>
                <?php
