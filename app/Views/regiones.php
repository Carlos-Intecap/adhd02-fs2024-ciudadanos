...
<body class="bg-info-subtle">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('niveles')?>">Niveles
                            académicos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?=base_url('regiones')?>">Regiones</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-2">Regiones</h1>

        <a href="nueva_region" class="btn btn-success"><i class="bi-plus-circle"></i> Nueva región</a>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td>
                        <a href="<?=base_url('buscar_region/').$region['cod_region']?>" class="btn btn-warning"><i
                                class="bi-pencil-square"></i></a>
                        <a href="<?=base_url('eliminar_region/').$region['cod_region']?>" class="btn btn-danger"><i
                                class="bi-trash"></i></a>
                    </td>
                </tr>
                <?php
